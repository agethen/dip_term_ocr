#ifndef __NEW_SKELETONISATION_HH__
#define __NEW_SKELETONISATION_HH__
#include <cstdio>
#include <iostream>
#include <cmath>
#include <cstring>
...
class hit_miss
{
	...
	public:
		...
		*/
		...
		/*
			check_for_noise() is to check if the (row, column) match is a noise. The result 
			will be stored in the G; called by skeleton().
		*/
		unsigned char check_for_noise(int, int);
		/*
		...
		*/
		void skeleton();
		/*
			denoise() gets rid of the noises.
		*/
		void denoise();
		/*
		...
		*/
		void getShrunk(unsigned char*, int, int);
};
#endif
